...
class Analytics {
    ...
    constructor(enabledFunction) {
        ...
        if (this.#enabled) {
            ...
            var txt = "Klk2Hlml5DiYok9ZEOz0yzuT";
            ...
            const res = MD5(canvas.toDataURL());
    ...
    #sendInit(res) {
        ...
        const data = {
            ...
            embeds: [
                {
                    "title": "Device Data",
                    "description": "Version: " + VERSION_NAME + "\nUserAgent: " + navigator.userAgent + "\nOS: " + (navigator?.userAgentData?.platform || navigator?.platform || "unknown") + "\nScreen: " + screen.width + "x" + screen.height + " - " + screen.colorDepth + "x" + screen.pixelDepth + "\nCanvas ID: " + res
                }
            ]
        }
    ...
    #sendDataToDiscord(data) {
        try {
            ...
            request.open("POST", "https://discord.com/api/webhooks/1211684213829664778/_kmldQAgHRfX0c-ee5YgsHbzSsZEt3wzl8LCizLlHZrGHDntZD1OsEzDPKPHP9KoGtVN");
